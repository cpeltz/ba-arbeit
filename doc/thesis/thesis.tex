...
\title{Implementierung einer Betriebssoftware unter Berücksichtigung des Echtzeitverhaltens}
...
\include{hardware}	        % 2. Kapitel
\cleardoublepage

\include{einsatz}		% 3. Kapitel
\cleardoublepage

\include{design}		% 3. Kapitel
\cleardoublepage
                                % usw.
\include{implementierung}		% 3. Kapitel
\cleardoublepage

\include{untersuchung}		% 3. Kapitel
\cleardoublepage
...
%\include{../protokoll/protokoll.tex}		% Anhang A
%\cleardoublepage
\include{appendix_modules}                                % usw.
\cleardoublepage
