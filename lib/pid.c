...
void
pid_Init(const int16_t pfactor, const int16_t ifactor, const int16_t dfactor,
...
uint8_t
pid_Controller(const uint8_t setPoint, const int16_t processValue, pid_data_t * pid)
{
  int16_t error = 0;
  int16_t p_term = 0;
  int32_t i_term = 0;
